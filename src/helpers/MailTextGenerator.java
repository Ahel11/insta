...
public class MailTextGenerator {
    ...
    public static String generateMailText() {
        String textToReturn = "Hey, how are you doing? I stumbled upon your profile,\n" +
                "\n" +
                "I am connecting with you in regards to promoting your Instagram account and increasing your followerbase, would you like to discuss more?\n" +
                " \n" +
                "Regards,";

        String positiveWords = generatePositiveWords(3);
    ...
    public static String generatePositiveWords(int nr) {
    ...
    public static String[] getMails() {
        String allFiles = "";
        try {
             allFiles = new String(Files.readAllBytes(Paths.get("C:\\Users\\ahmad\\Desktop\\generalFiles\\Instagram\\db\\mails.txt")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        int randNr = new Random().nextInt()%allFiles.split("\n").length;
